...
import etc.trader.Server.rest.errors.EmailAlreadyUsedException;
import etc.trader.Server.rest.errors.InternalServerErrorException;
import etc.trader.Server.rest.errors.InvalidPasswordException;
import etc.trader.Server.rest.errors.LoginAlreadyUsedException;
import etc.trader.Server.rest.vm.ManagedUserVM;
import etc.trader.Server.security.SecurityUtils;
import etc.trader.Server.service.UserService;
...
public class AccountResource {
   ...
   // private final PersistentTokenRepository persistentTokenRepository;
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        userService.activateRegistration(user.getId());
     ...
     */
    @GetMapping("/activate")
    public void activateAccount(@RequestParam(value = "id") Long id) {
        Optional<User> user = userService.activateRegistration(id);
        if (!user.isPresent()) {
